#!/usr/bin/env node
/**
 * build_mermaid.js — pre-renders Mermaid diagrams in HTML docs to inline SVG
 *
...
function collectHtmlFiles(dir) {
  ...
  for (const entry of fs.readdirSync(dir, { withFileTypes: true })) {
    if (entry.isDirectory()) {
      // Skip jsdoc — those are generated by JSDoc and should not be modified
      if (entry.name === 'jsdoc') continue;
