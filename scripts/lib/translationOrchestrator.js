...
async function translateTitlesBatch(node, translateWithCache, shouldTranslateUI) {
  ...
  try {
    ...
    // DEPRECATED shim — translation orchestrator moved under ./translation
    // Keep a forwarder to the new implementation to avoid breaking older requires.
    module.exports = require('./translation').orchestrator || require('./translation/translationOrchestrator');
