/*
 * Tests for mediaHelper.processNodeMedia
 * Covers: service injection via downloader/parseReadme stubs, explicit project-image
 * path preference over AST candidate, and badge/SVG image-ref rewriting.
 */
