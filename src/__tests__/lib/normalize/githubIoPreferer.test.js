/*
 * Tests for githubIoPreferer.tryGithubIo
 * Covers: GitHub Pages reachability probing, X-Frame-Options DENY rejection,
 * non-200 response handling, and the injected-axios instance pattern.
 */
