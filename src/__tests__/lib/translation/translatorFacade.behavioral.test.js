/*
 * Behavioral smoke-test for translatorFacade.translateNode
 * Covers: translated fields (summary_de, title_de) written onto the node
 * when a real translate function is provided, without mocking facade internals.
 */
