...
- **Scenario**: A change lands on `main`. **Response**: The documentation site and, where in scope, the coverage report are republished to GitHub Pages automatically — the deployed docs never drift far from the code they describe.
