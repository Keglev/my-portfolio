...
- **No client-side state library** — component-local `useState` is sufficient; no shared mutable state exists across unrelated components. See [data-flow.md](data-flow.md).
